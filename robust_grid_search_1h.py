#!/usr/bin/env python3
"""
Improved Grid Search with Overfitting Prevention for 1H timeframe
...
def improved_grid_search(df: pd.DataFrame) -> Tuple[Dict, Dict]:
    ...
    """
    print("\n" + "=" * 80)
    print("IMPROVED GRID SEARCH WITH OVERFITTING PREVENTION (1H TIMEFRAME)")
    print("=" * 80)
...
def main():
    """Run improved grid search for 1H"""
